...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_ergodox_pretty(
    ...
    LT(1,KC_GRAVE), KC_QUOTE,       KC_CAPS,        MT(MOD_LALT, KC_DOWN),KC_UP,                                                                                                          KC_LEFT,        KC_LBRC,        KC_RBRC,        KC_RIGHT,       LT(1,KC_BSLS),
                                                                                                    MT(MOD_LALT, KC_APPLICATION),KC_LEFT_GUI,    KC_LEFT_ALT,    MT(MOD_LCTL, KC_ESCAPE),
                                                                                                                    KC_LEFT_ALT,    KC_RIGHT_CTRL,
                                                                                    KC_SPACE,       KC_BSPC,        MT(MOD_LCTL, KC_ESCAPE),KC_RIGHT_ALT,   KC_TAB,         KC_ENTER
  ),
